...
WebUI.setText(findTestObject('Buttons/surName'), 'Juonaa')
...
WebUI.setText(findTestObject('Page_KenyaEMR/input_ID or name (3 chars min)_query'), 'juonaa')
...
WebUI.setText(findTestObject('Registration/Forms/LMP_Date'), '5-05-2020', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Registration/KP_Forms/kp_STI_15'), '20-Jun-2020')
...
WebUI.setText(findTestObject('Registration/KP_Forms/kp_referal_date'), '11-May-2020')
...
WebUI.setText(findTestObject('Registration/KP_Forms/kp_followup_date'), '11-May-2020')
...
WebUI.setText(findTestObject('Registration/KP_Forms/kp_followup_02'), '11-May-2020')
...
WebUI.click(findTestObject('Registration/KP_Forms/kp_add_rlnship_search'))

WebUI.setText(findTestObject('Registration/KP_Forms/kp_add_rlnship_search'), 'mar')

WebUI.selectOptionByValue(findTestObject('Registration/KP_Forms/kp_rlnship_type'), '12:A', true)

WebUI.click(findTestObject('Registration/KP_Forms/kp_rlnship_start_date'))
