...
WebUI.navigateToUrl('https://41.206.32.54:8500/openmrs/login.htm')

WebUI.click(findTestObject('Registration/Forms/advance-button'))

WebUI.click(findTestObject('Registration/Forms/proceed'))
...
WebUI.setText(findTestObject('Buttons/clinicNo'), '251924008')

WebUI.delay(3, FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Buttons/idNo'), '251294007')

WebUI.delay(2, FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Buttons/surName'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Buttons/surName'), 'Penne')

WebUI.click(findTestObject('Buttons/firstName'))

WebUI.setText(findTestObject('Buttons/firstName'), 'Ginnine')
...
WebUI.setText(findTestObject('Registration/Forms/HTS_Date'), '26-Mar-2020')
...
WebUI.setText(findTestObject('Registration/Forms/hts_linkage_CCC_number'), '1968106700')
...
WebUI.setText(findTestObject('Registration/Forms/hts_linkage_date_enrolled_field'), '04-Mar-2020', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Registration/Forms/hts_linkage_art_date'), '26-Mar-2020', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Registration/Forms/hiv_enrollment_date'), '26-Mar-2020', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Registration/Forms/hiv_enrollmrnt_number'), '1985873609')
...
WebUI.setText(findTestObject('Registration/Forms/hiv_arvs_start_date'), '26-Mar-2020', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Registration/Forms/Adherance_date_first_session'), '26-Mar-2020', FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Registration/Forms/complain-date'), '26-Mar-2020')
...
WebUI.click(findTestObject('Registration/Forms/drug_other'))

WebUI.setText(findTestObject('Registration/Forms/drug_other'), 'ctx')

WebUI.delay(2)

WebUI.click(findTestObject('Registration/Forms/drug_other_ctx'))
...
WebUI.click(findTestObject('Registration/Forms/drug_instruction_unit'))

WebUI.setText(findTestObject('Registration/Forms/drug_instruction_unit'), 'Milligram')

WebUI.click(findTestObject('Registration/Forms/drug_instruction_unit_01'))

WebUI.click(findTestObject('Registration/Forms/drug-frequency'))

WebUI.setText(findTestObject('Registration/Forms/drug-frequency'), 'Daily')

WebUI.click(findTestObject('Registration/Forms/Daily-frequency'))

WebUI.click(findTestObject('Registration/Forms/route'))

WebUI.setText(findTestObject('Registration/Forms/route'), 'Oral')
